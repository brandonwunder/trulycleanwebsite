...
export default function GuaranteeCertificate() {
  return (
    ...
    >
      {/* Background accents */}
      <motion.div
        className="absolute top-0 left-1/4 w-80 h-80 bg-vibrant-teal/5 rounded-full blur-3xl pointer-events-none"
        animate={{ y: [0, 50, 0] }}
      ...
      >
        ...
        <motion.div variants={slideUp} className="relative group">
          ...
          <div className="absolute -inset-[3px] bg-gradient-to-r from-vibrant-teal via-vibrant-green to-vibrant-teal rounded-3xl opacity-40 group-hover:opacity-60 transition-opacity duration-500 blur-sm" />
          ...
          <div className="relative glass-dark p-12 md:p-16 rounded-3xl border-2 border-white/10 backdrop-blur-xl">
            ...
            >
              <Award className="w-8 h-8 text-vibrant-teal" />
            </motion.div>
            <motion.div
            ...
            {/* Main seal icon */}
            <motion.div
              className="w-24 h-24 mx-auto mb-8 bg-gradient-to-br from-vibrant-teal to-vibrant-green rounded-full flex items-center justify-center shadow-2xl"
              animate={{ rotate: [0, 5, -5, 0] }}
