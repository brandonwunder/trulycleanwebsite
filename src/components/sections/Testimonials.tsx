...
const testimonials = [
  {
    ...
    rating: 5,
    text: 'TrulyClean transformed my home! Their attention to detail is incredible. I highly recommend their services to anyone looking for professional cleaning.',
    initials: 'SJ',
  ...
  },
  {
    ...
    location: 'Anthem, AZ',
    rating: 5,
    text: "We've been using TrulyClean for our office for 6 months now. The team is reliable, thorough, and professional. Our workspace has never looked better!",
    initials: 'MC',
  ...
  },
  {
    ...
    location: 'Phoenix, AZ',
    rating: 5,
    text: "TrulyClean made my move-out process so much easier. They got my deposit back in full thanks to their thorough cleaning. Worth every penny!",
    initials: 'DT',
  ...
  },
  {
    ...
    rating: 5,
    text: "I've tried many cleaning services over the years, and TrulyClean is by far the best. They're consistent, punctual, and my house sparkles after every visit.",
    initials: 'LM',
