...
export default function Contact() {
  ...
  return (
    <section
      id="quote-form"
      className="py-20 md:py-28 bg-gradient-to-br from-gray-50 via-vibrant-teal/5 to-gray-50 relative overflow-hidden"
    >
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto mb-16 relative">
          ...
          >
            ...
            >
              {trustBadges.map((badge, i) => (
                <div
                  key={i}
                  className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-vibrant-teal/10 border border-vibrant-teal/20 backdrop-blur-sm"
                >
            ...
            <div className="absolute -inset-[1px] bg-gradient-to-br from-vibrant-teal via-vibrant-green to-vibrant-teal rounded-2xl opacity-20" />
          ...
          >
            ...
            >
              <div className="glass p-4 rounded-xl border border-vibrant-teal/10">
                      ...
                      <Card variant="glass" size="md" hover="lift" className="group" interactive>
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="font-semibold text-navy-dark mb-1">{method.title}</h4>
                            {method.href ? (
                              <a
                                href={method.href}
