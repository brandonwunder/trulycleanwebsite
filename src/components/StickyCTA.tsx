      ...
      {isVisible && (
        ...
        >
          <div className="relative">
            ...
            {/* Main CTA Button */}
            <div className="glass rounded-full p-1.5 shadow-2xl border border-deep-teal/30">
              <button
                onClick={scrollToQuote}
                className="flex items-center gap-2 px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-deep-teal to-deep-teal/90 text-white font-heading font-bold rounded-full hover:shadow-lg transition-all duration-200 hover:scale-105 active:scale-95 whitespace-nowrap"
              >
